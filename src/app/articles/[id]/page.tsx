        ...
        <section className='fix-height container m-auto w-full px-5 pt-8 md:w-3/4'>
            ...
            <div className='mt-7'>
                {payload ? (<AddCommentForm articleId={article.id} />) : (
                    <p className='text-blue-600 md:text-xl'>To write a comment you need to log in first</p>
                )}
            </div>
            <h4 className='text-xl text-center text-gray-800 ps-1 font-semibold mb-4 mt-7 '>
                Comments
            </h4>
